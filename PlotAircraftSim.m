...
%     6 plots
    ...
    hold on
    grid on
    title("Elevator Deflection (Degrees)")
    xlabel("Time (s)")
    ylabel("Deflection")
    ...
    hold on
    grid on
    title("Aileron Deflection (Degrees)")
    xlabel("Time (s)")
    ylabel("Deflection")
    ...
    hold on
    grid on
    title("Rudder Deflection (Degrees)")
    xlabel("Time (s)")
    ylabel("Deflection")
    
    subplot(414)
    plot(time, control_input_array(4,:), col)  %%% may need to normalize this so it shows as a fraction from 0-1
    hold on
    grid on
